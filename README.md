...
Разработать приложение для организации путешествий

Краткий перечень функциональных требований.
Иметь возможность:
- зарегестрироваться в приложении;
- редактировать профиль;
- просматривать отели, рестораны, события, билеты;
- создавать туры из одного и более туров по городу и туры по городам.
